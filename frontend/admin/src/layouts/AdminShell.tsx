...
const styles: Record<string, React.CSSProperties> = {
  ...
  brandSub: { color: '#8E8E93', fontSize: 12, padding: '4px 8px 20px', margin: 0 },
  ...
  headerEyebrow: { margin: 0, color: '#8E8E93', fontSize: 11, letterSpacing: 1 },
  headerTitle: { margin: '4px 0 0', fontSize: 20, fontWeight: 700 },
  headerRight: { display: 'flex', alignItems: 'center', gap: 12 },
  email: { color: '#A0A0A0', fontSize: 13 },
  avatar: {
    width: 36,
    height: 36,
    borderRadius: '50%',
    background: 'linear-gradient(135deg, #6A00FF, #0055FF)',
    display: 'flex',
    alignItems: 'center',
