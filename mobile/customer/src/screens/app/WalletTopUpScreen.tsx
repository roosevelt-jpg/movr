...
const styles = StyleSheet.create({
  ...
  amount: { color: '#fff', fontSize: 28, fontWeight: '700', textAlign: 'center' },
  ...
  payOn: { borderColor: colors.motionBlue, backgroundColor: '#0A1224' },
  payText: { color: '#fff', fontWeight: '500' },
  check: {
    color: '#fff',
