...
/** Settlement rails — MoMo, cash agents, receipts, disputes. */
export default function SettlementHubScreen({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <Text style={styles.title}>Move money. Keep trust.</Text>
      <Text style={styles.sub}>
        {promise?.matchSlaText || 'Fast match'} · {promise?.noShowText || 'No-show credit'}
      </Text>
      ...
      <Text style={styles.h2}>Link MoMo</Text>
      <TextInput
        style={styles.input}
        value={momo.provider}
      ...
      <Pressable style={styles.btn} onPress={saveMomo}>
        <Text style={styles.btnText}>Save rail</Text>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  sub: { color: '#a1a1aa', marginTop: 6, marginBottom: 12, fontSize: 13 },
  muted: { color: '#71717a', fontSize: 12, marginBottom: 6 },
