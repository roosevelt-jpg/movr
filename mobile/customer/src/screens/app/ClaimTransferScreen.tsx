...
const styles = StyleSheet.create({
  ...
  brand: { color: '#fff', fontSize: 24, fontWeight: '800', marginBottom: spacing[8] },
  icon: {
    width: 80,
    height: 80,
    borderRadius: 40,
  ...
  amount: { color: '#fff', fontSize: 42, fontWeight: '700', marginBottom: spacing[4] },
  errorTitle: { color: '#fff', fontSize: 20, fontWeight: '600', marginBottom: 8 },
  body: {
